                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="/pages/salesmanCreate" method="POST">
                                    <?= csrf_field(); ?>

                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Nama Salesman</label>
                                        <input name="nama_salesman" type="text" maxlength="30" required class="form-control" placeholder="Masukan Nama Salesman">
                                    </div>
